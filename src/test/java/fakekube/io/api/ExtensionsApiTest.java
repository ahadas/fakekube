...
public class ExtensionsApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost", ExtensionsApi.class, providers);
     ...
     */
    @Test
    public void getExtensionsAPIGroupTest() {
        //Response response = api.getExtensionsAPIGroup();
