...
public class AuthorizationApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost", AuthorizationApi.class, providers);
     ...
     */
    @Test
    public void getAuthorizationAPIGroupTest() {
        //Response response = api.getAuthorizationAPIGroup();
