...
public class DiscoveryApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost", DiscoveryApi.class, providers);
     ...
     */
    @Test
    public void getDiscoveryAPIGroupTest() {
        //Response response = api.getDiscoveryAPIGroup();
