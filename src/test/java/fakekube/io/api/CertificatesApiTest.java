...
public class CertificatesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost", CertificatesApi.class, providers);
     ...
     */
    @Test
    public void getCertificatesAPIGroupTest() {
        //Response response = api.getCertificatesAPIGroup();
