...
public class NetworkingApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://localhost", NetworkingApi.class, providers);
     ...
     */
    @Test
    public void getNetworkingAPIGroupTest() {
        //Response response = api.getNetworkingAPIGroup();
