...
import fakekube.io.model.IoK8sApiStorageV1VolumeError;
...
public class IoK8sApiStorageV1VolumeAttachmentStatus  {
  ...
  **/
  private IoK8sApiStorageV1VolumeError attachError = null;
  ...
  **/
  private IoK8sApiStorageV1VolumeError detachError = null;
 /**
   * The last error encountered during attach operation, if any. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.
   * @return attachError
  **/
  @JsonProperty("attachError")
  public IoK8sApiStorageV1VolumeError getAttachError() {
    return attachError;
  }

  public void setAttachError(IoK8sApiStorageV1VolumeError attachError) {
    this.attachError = attachError;
  }

  public IoK8sApiStorageV1VolumeAttachmentStatus attachError(IoK8sApiStorageV1VolumeError attachError) {
    this.attachError = attachError;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiStorageV1VolumeAttachmentStatus attached(Boolean attached) {
    this.attached = attached;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiStorageV1VolumeAttachmentStatus attachmentMetadata(Map<String, String> attachmentMetadata) {
    this.attachmentMetadata = attachmentMetadata;
    return this;
  }

  public IoK8sApiStorageV1VolumeAttachmentStatus putAttachmentMetadataItem(String key, String attachmentMetadataItem) {
  ...
  **/
  ...
  public IoK8sApiStorageV1VolumeError getDetachError() {
    return detachError;
  }

  public void setDetachError(IoK8sApiStorageV1VolumeError detachError) {
    this.detachError = detachError;
  }

  public IoK8sApiStorageV1VolumeAttachmentStatus detachError(IoK8sApiStorageV1VolumeError detachError) {
    this.detachError = detachError;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class IoK8sApiStorageV1VolumeAttachmentStatus {\n");
