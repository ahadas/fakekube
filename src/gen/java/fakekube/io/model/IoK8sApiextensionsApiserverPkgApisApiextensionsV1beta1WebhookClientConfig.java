...
import fakekube.io.model.IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference;
...
public class IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig  {
  ...
  **/
  private IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference service = null;
 ...
 @Pattern(regexp="^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$")  public byte[] getCaBundle() {
  ...
  public IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig caBundle(byte[] caBundle) {
    this.caBundle = caBundle;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference getService() {
    return service;
  }

  public void setService(IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference service) {
    this.service = service;
  }

  public IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig service(IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference service) {
    this.service = service;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig url(String url) {
    this.url = url;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig {\n");
