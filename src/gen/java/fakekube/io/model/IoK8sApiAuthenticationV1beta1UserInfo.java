...
public class IoK8sApiAuthenticationV1beta1UserInfo  {
  ...
  **/
  ...
  public IoK8sApiAuthenticationV1beta1UserInfo extra(Map<String, List<String>> extra) {
    this.extra = extra;
    return this;
  }

  public IoK8sApiAuthenticationV1beta1UserInfo putExtraItem(String key, List<String> extraItem) {
  ...
  **/
  ...
  public IoK8sApiAuthenticationV1beta1UserInfo groups(List<String> groups) {
    this.groups = groups;
    return this;
  }

  public IoK8sApiAuthenticationV1beta1UserInfo addGroupsItem(String groupsItem) {
  ...
  **/
  ...
  public IoK8sApiAuthenticationV1beta1UserInfo uid(String uid) {
    this.uid = uid;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiAuthenticationV1beta1UserInfo username(String username) {
    this.username = username;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class IoK8sApiAuthenticationV1beta1UserInfo {\n");
