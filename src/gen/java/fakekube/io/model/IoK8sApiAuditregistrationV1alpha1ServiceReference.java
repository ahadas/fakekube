...
public class IoK8sApiAuditregistrationV1alpha1ServiceReference  {
  ...
  **/
  ...
  public IoK8sApiAuditregistrationV1alpha1ServiceReference name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiAuditregistrationV1alpha1ServiceReference namespace(String namespace) {
    this.namespace = namespace;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiAuditregistrationV1alpha1ServiceReference path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public IoK8sApiAuditregistrationV1alpha1ServiceReference port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class IoK8sApiAuditregistrationV1alpha1ServiceReference {\n");
