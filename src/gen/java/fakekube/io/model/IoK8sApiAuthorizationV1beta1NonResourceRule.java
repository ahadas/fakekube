...
public class IoK8sApiAuthorizationV1beta1NonResourceRule  {
  ...
  **/
  ...
  public IoK8sApiAuthorizationV1beta1NonResourceRule nonResourceURLs(List<String> nonResourceURLs) {
    this.nonResourceURLs = nonResourceURLs;
    return this;
  }

  public IoK8sApiAuthorizationV1beta1NonResourceRule addNonResourceURLsItem(String nonResourceURLsItem) {
  ...
  **/
  ...
  public IoK8sApiAuthorizationV1beta1NonResourceRule verbs(List<String> verbs) {
    this.verbs = verbs;
    return this;
  }

  public IoK8sApiAuthorizationV1beta1NonResourceRule addVerbsItem(String verbsItem) {
  ...
  public String toString() {
    ...
    sb.append("class IoK8sApiAuthorizationV1beta1NonResourceRule {\n");
