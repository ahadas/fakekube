...
public interface NodeV1beta1Api  {
    ...
    @ApiOperation(value = "", tags={ "node_v1beta1",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 201, message = "Created", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 202, message = "Accepted", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response createNodeV1beta1RuntimeClass(@Valid IoK8sApiNodeV1beta1RuntimeClass body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response deleteNodeV1beta1RuntimeClass(@PathParam("name") String name, @QueryParam("pretty") String pretty, @Valid IoK8sApimachineryPkgApisMetaV1DeleteOptions body, @QueryParam("dryRun") String dryRun, @QueryParam("gracePeriodSeconds") Integer gracePeriodSeconds, @QueryParam("orphanDependents") Boolean orphanDependents, @QueryParam("propagationPolicy") String propagationPolicy);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response patchNodeV1beta1RuntimeClass(@PathParam("name") String name, @Valid IoK8sApimachineryPkgApisMetaV1Patch body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager, @QueryParam("force") Boolean force);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response readNodeV1beta1RuntimeClass(@PathParam("name") String name, @QueryParam("pretty") String pretty, @QueryParam("exact") Boolean exact, @QueryParam("export") Boolean export);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 201, message = "Created", response = IoK8sApiNodeV1beta1RuntimeClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response replaceNodeV1beta1RuntimeClass(@PathParam("name") String name, @Valid IoK8sApiNodeV1beta1RuntimeClass body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response watchNodeV1beta1RuntimeClass(@PathParam("name") String name, @QueryParam("allowWatchBookmarks") Boolean allowWatchBookmarks, @QueryParam("continue") String _continue, @QueryParam("fieldSelector") String fieldSelector, @QueryParam("labelSelector") String labelSelector, @QueryParam("limit") Integer limit, @QueryParam("pretty") String pretty, @QueryParam("resourceVersion") String resourceVersion, @QueryParam("timeoutSeconds") Integer timeoutSeconds, @QueryParam("watch") Boolean watch);
