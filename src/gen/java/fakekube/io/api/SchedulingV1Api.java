...
public interface SchedulingV1Api  {
    ...
    @ApiOperation(value = "", tags={ "scheduling_v1",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 201, message = "Created", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 202, message = "Accepted", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response createSchedulingV1PriorityClass(@Valid IoK8sApiSchedulingV1PriorityClass body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response deleteSchedulingV1CollectionPriorityClass(@QueryParam("pretty") String pretty, @QueryParam("allowWatchBookmarks") Boolean allowWatchBookmarks, @Valid IoK8sApimachineryPkgApisMetaV1DeleteOptions body, @QueryParam("continue") String _continue, @QueryParam("dryRun") String dryRun, @QueryParam("fieldSelector") String fieldSelector, @QueryParam("gracePeriodSeconds") Integer gracePeriodSeconds, @QueryParam("labelSelector") String labelSelector, @QueryParam("limit") Integer limit, @QueryParam("orphanDependents") Boolean orphanDependents, @QueryParam("propagationPolicy") String propagationPolicy, @QueryParam("resourceVersion") String resourceVersion, @QueryParam("timeoutSeconds") Integer timeoutSeconds, @QueryParam("watch") Boolean watch);
    ...
    @ApiOperation(value = "", tags={ "scheduling_v1",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiSchedulingV1PriorityClassList.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response listSchedulingV1PriorityClass(@QueryParam("pretty") String pretty, @QueryParam("allowWatchBookmarks") Boolean allowWatchBookmarks, @QueryParam("continue") String _continue, @QueryParam("fieldSelector") String fieldSelector, @QueryParam("labelSelector") String labelSelector, @QueryParam("limit") Integer limit, @QueryParam("resourceVersion") String resourceVersion, @QueryParam("timeoutSeconds") Integer timeoutSeconds, @QueryParam("watch") Boolean watch);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response patchSchedulingV1PriorityClass(@PathParam("name") String name, @Valid IoK8sApimachineryPkgApisMetaV1Patch body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager, @QueryParam("force") Boolean force);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response readSchedulingV1PriorityClass(@PathParam("name") String name, @QueryParam("pretty") String pretty, @QueryParam("exact") Boolean exact, @QueryParam("export") Boolean export);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 201, message = "Created", response = IoK8sApiSchedulingV1PriorityClass.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response replaceSchedulingV1PriorityClass(@PathParam("name") String name, @Valid IoK8sApiSchedulingV1PriorityClass body, @QueryParam("pretty") String pretty, @QueryParam("dryRun") String dryRun, @QueryParam("fieldManager") String fieldManager);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = IoK8sApimachineryPkgApisMetaV1WatchEvent.class),
        @ApiResponse(code = 401, message = "Unauthorized") })
    public Response watchSchedulingV1PriorityClassList(@QueryParam("allowWatchBookmarks") Boolean allowWatchBookmarks, @QueryParam("continue") String _continue, @QueryParam("fieldSelector") String fieldSelector, @QueryParam("labelSelector") String labelSelector, @QueryParam("limit") Integer limit, @QueryParam("pretty") String pretty, @QueryParam("resourceVersion") String resourceVersion, @QueryParam("timeoutSeconds") Integer timeoutSeconds, @QueryParam("watch") Boolean watch);
}
